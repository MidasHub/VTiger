<?php /* Smarty version Smarty-3.1.7, created on 2021-07-29 14:31:22
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/VTEStore/Warnings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11842454836102bbba805d67-29117028%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51a8a8324890c6c32a562a2765a187d3e2277ec2' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/VTEStore/Warnings.tpl',
      1 => 1627568345,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11842454836102bbba805d67-29117028',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6102bbba86d40',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6102bbba86d40')) {function content_6102bbba86d40($_smarty_tpl) {?><div id="globalmodal">
...
<?php }?></td>
 ...
 (<?php echo $_smarty_tpl->tpl_vars['ERROR_NUM']->value;?>
                            ...
                            <div class="summaryWidgetContainer" style="width:45%; height:240px;border:1px solid #ccc;margin: 20px 19px 0 0; float: left; font-size: 11px;">
...
:</strong>
 ...
 layouts/vlayout/modules: <?php if ($_smarty_tpl->tpl_vars['MESSAGES']->value['layouts_vlayout_modules']==1){?><font color="green">OK</font><?php }else{ ?><font color="red"><?php echo vtranslate('Insufficient permissions','VTEStore');?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['VTVERSION']->value=='vt7'){?><br>Folder layouts/v7/modules: <?php if ($_smarty_tpl->tpl_vars['MESSAGES']->value['layouts_v7_modules']==1){?><font color="green">OK</font><?php }else{ ?><font color="red"><?php echo vtranslate('Insufficient permissions','VTEStore');?>
 ...
 config.inc.php: <?php if ($_smarty_tpl->tpl_vars['MESSAGES']->value['config']==1){?><font color="green">OK</font><?php }else{ ?><font color="red">$root_directory missing '/' at the end</font> <a href="https://www.vtexperts.com/vtiger-extension-insufficient-permissions/" target="_blank" style="text-decoration: underline!important;"> <?php echo vtranslate('LBL_MORE_DETAILS','VTEStore');?>
                            ...
                            <div class="summaryWidgetContainer" style="width:48%; height:240px;border:1px solid #ccc;margin: 20px 0px 0 0; float: left; font-size: 11px;">

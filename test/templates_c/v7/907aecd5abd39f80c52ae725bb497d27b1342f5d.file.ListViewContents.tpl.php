<?php /* Smarty version Smarty-3.1.7, created on 2021-07-16 23:54:40
         compiled from "/var/www/html/VTiger/includes/runtime/../../layouts/v7/modules/ModuleLinkCreator/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:86049937860f21c40122511-01987019%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '907aecd5abd39f80c52ae725bb497d27b1342f5d' => 
    array (
      0 => '/var/www/html/VTiger/includes/runtime/../../layouts/v7/modules/ModuleLinkCreator/ListViewContents.tpl',
      1 => 1626475493,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '86049937860f21c40122511-01987019',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60f21c4013fb1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60f21c4013fb1')) {function content_60f21c4013fb1($_smarty_tpl) {?>
...
?><th nowrap <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last){?> colspan="2" <?php }?>><?php if ($_smarty_tpl->tpl_vars['COLUMNNAME']->value!='description'){?><?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }?></th><?php } ?></tr></thead><tbody class="overflow-y"><?php  $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->_loop = false;
...
$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->_loop = true;
 ...
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration++;
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last = $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration === $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->total;
?><?php if ($_smarty_tpl->tpl_vars['COLUMNNAME']->value!='description'){?><td class="<?php if ($_smarty_tpl->tpl_vars['COLUMNNAME']->value=='filename'){?>listViewEntryValue<?php }?> <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
<?php }?></td><?php }?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last){?><td nowrap class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"><div class="actions pull-right"><span class="actionImages">&nbsp;&nbsp;<a data-link ="index.php?module=ModuleLinkCreator&action=ActionAjax&mode=delete&record=<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('id');?>

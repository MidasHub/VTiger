...
$languageStrings = array(
    'VTEItemLookup' => 'Item Lookup',
    'LBL_ENABLE_MODULE' => 'Enable Item Lookup',
    'MODULE_LBL' => 'Item Lookup',
    ...
    'LBL_DEFAULT_MODULE_TOOLTIP' => 'By default - Products will open up in the item lookup popup. You can change the default here.',
    'LBL_HIDE_ADD_PRODUCT_TOOLTIP' => "By enabling this - you can hide 'Add Product' button on the quote/invoice/order and force users to Item Lookup instead.",
    'LBL_HIDE_ADD_SERVICE_TOOLTIP' => "By enabling this - you can hide 'Add Service' button on the quote/invoice/order and force users to Item Lookup instead.",
    'Miscellaneous' => 'Divers',
    'Bundles Only' => 'Bundles uniquement',

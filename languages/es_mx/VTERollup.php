...
$languageStrings = array(
    'VTERollup' => 'Rollup/Calculate Fields',
    'LBL_ENABLE_MODULE' => 'Enable Rollup/Calculate Fields',
    'LBL_ADD_FIELDS_TO_UPDATE' => 'Add Fields to update',
    'LBL_ADD_MAPPING' => 'Add Mapping',
    'LBL_SOURCE' => 'Source',
    'LBL_DESTINATION' => 'Destination',
//    'LBL_ADD_FIELDS_TO_UPDATE' => '',

    /* For License page - Begin */
    'MODULE_LBL' => 'Rollup/Calculate Fields',
    ...
    'ADDNOTE_TARGET_FIELD1' => 'Only Integer, Currency, Decimal, Precent and Text fields can be calculated',
    'ADDNOTE_TARGET_FIELD2' => 'Target field is the one which will get updated from the Source Field',
    'ADDNOTE_SOURCE_FIELD' => 'Only Integer, Currency, Decimal, Precent and Text fields can be calculated',
    'ADDNOTE_METHOD' => 'Target field is the one which will get updated from the Source Field',
    'LBL_TARGET_FIELD' => 'Target field',
    'LBL_SOURCE_FIELD' => 'Source field',
    'LBL_METHOD' => 'Method',
    'LBL_VTERollupTask' => 'Rollup/Calculate Fields',
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'Rollup/Calculate Fields Workflow Tasks have to be creating using workflows. Please go to Automation > Workflows, create new/edit existing workflow and you see under "Add Tasks" - there will be new option for "Rollup/Calculate Fields".<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE_V6'=>'Rollup/Calculate Fields Workflow Tasks have to be creating using workflows. Please go to Other Settings > Workflows, create new/edit existing workflow and you see under "Add Tasks" - there will be new option for "Rollup/Calculate Fields".<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',

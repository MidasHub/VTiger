...
$languageStrings = array(
    'RealTimeFieldFormulas' => 'Real Time Field Formulas',
    'LBL_ENABLE_MODULE' => 'Enable Real Time Field Formulas',
    'MODULE_LBL' => 'Real Time Field Formulas',
    ...
    'LBL_RealtimeFieldFormulasTask' => 'Realtime Field Formulas',
    /* For License page - End */
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'Formulas has to be creating using workflows. Please go to Automation > Workflows, create new/edit existing workflow and you see under "Add Tasks" - there will be new option for "Field Formula".<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension .',
);

...
$languageStrings = array(
    ...
    'LBL_SAVE' => 'Save',
    'LBL_CREATE_ANOTHER' => 'Create Another',

    /* For License page - Begin */
    'MODULE_LBL' => 'Calendar Popup',
    ...
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'Selected modules will become tabs in the popup. Please go to the calendar view, click on the event and the popup with tabs should show up.<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',
);

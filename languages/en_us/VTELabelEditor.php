...
$languageStrings = array(
    ...
    'LBL_INFO_DESCRIPTION' => '<p>To edit the label, select language, module/file and the available labels will show up. You can also search for certain word e.g "Add Contact" and it will show all files that consist that label - you can then select the file and change the label.</p>
                                        <p>Most module file names as straight forward e.g Contacts.php is Contacts module, however there are some that not as clear. Please see the list below:</p>
                                        <p>
                                            Accounts.php > Organizations<br>
                                            HelpDesk.php > Tickets<br>
                                            Potentials.php > Opportunities<br>
                                            Events.php > Calendar
                                        </p>',
);

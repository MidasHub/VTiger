...
<html ng-app="mobileapp">
	<head>
		...
		<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/resources/libs/bootstrap-3.3.6/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/resources/libs/ui-bootstrap-tpls-0.14.3/ui-bootstrap-tpls-0.14.3.min.js"></script>

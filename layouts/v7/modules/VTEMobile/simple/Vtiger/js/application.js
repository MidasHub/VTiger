 ...
 *
 **************************************************************************************/
window.mobileapp = angular.module('mobileapp', ['ngMaterial', 'ngTouch', 'ngAnimate','ngMaterialDatePicker','ui.bootstrap']);
mobileapp.factory('$api', function ($http, $mdDialog) {
    ...
    return function (operation, params, next) {
        ...
        if(operation === 'saveRecord' && params.module == undefined) {

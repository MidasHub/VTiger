...
<md-sidenav class="md-sidenav-left" md-component-id="left">
    ...
    <md-list class="sidenav-module-list">
        <md-list-item ng-if="checkModules['Events']" ng-click="navigationToggle(); loadList('Events');" md-ink-ripple class="md-1-line">
            <span style="font-size:14px;" class="vicon-calendar"></span> &nbsp; 
            <span class="vmodule-name">Events</span>
        </md-list-item>
        <md-list-item ng-if="checkModules['Calendar']" ng-click="navigationToggle(); loadList('Calendar');" md-ink-ripple class="md-1-line">
            <span style="font-size:14px;" class="vicon-calendar"></span> &nbsp; 
            <span class="vmodule-name">Tasks</span>
        </md-list-item>
        <md-list-item ng-if="checkModules['Documents']"  ng-click="navigationToggle(); loadList('Documents');" md-ink-ripple class="md-1-line">
            <span style="font-size:14px;" class="vicon-documents"></span> &nbsp;
            <span class="vmodule-name">Documents</span>
        </md-list-item>
        <md-divider ng-if="checkModules['Events'] || checkModules['Calendar']"></md-divider>

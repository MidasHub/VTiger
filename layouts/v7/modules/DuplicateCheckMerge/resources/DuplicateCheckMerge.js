                ...
                if(response.result.data.length > 0){
                    ...
                    for(var i=0; i<len; i++ ){
                        if(data[i].passive == 1){
                            ...
                            jQuery('#'+current_module+'_detailView_fieldLabel_'+data[i].fieldname+' span').append('<img class="dcm_items_refresh" data-fieldname="'+data[i].fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/refresh.png" width="16px;" height="16px;" style="display:none; vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                            jQuery('#'+current_module+'_detailView_fieldLabel_'+data[i].fieldname+' span .dcm_items_refresh').fadeIn(700);
                            jQuery('#_detailView_fieldLabel_'+data[i].fieldname+' span').append('<img class="dcm_items_refresh" data-fieldname="'+data[i].fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/refresh.png" width="16px;" height="16px;" style="vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                        }else if(data[i].passive == 0 && data[i].rtotr == 1){
                            if(data[i].duplicate_items.length > 0 || data[i].crosscheck.length > 0){
                                jQuery('#'+current_module+'_detailView_fieldLabel_'+data[i].fieldname+' span').append('<img class="dcm_items_valid" data-fieldname="'+data[i].fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/error.png" width="16px;" height="16px;" style="display:none; vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                                jQuery('#'+current_module+'_detailView_fieldLabel_'+data[i].fieldname+' span .dcm_items_valid').fadeIn(700);
                                jQuery('#_detailView_fieldLabel_'+data[i].fieldname+' span').append('<img class="dcm_items_valid" data-fieldname="'+data[i].fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/error.png" width="16px;" height="16px;" style="vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                                ...
                                if(data[i].duplicate_items.length > 0){
                                    ...
                                    if(data[i].duplicate_merge==1){
                                        html_buildin += '<a style="color:#7cfc00;" target="_blank" href="index.php?module=DuplicateCheckMerge&pmodule='+current_module+'&view=FindDuplicates&fields[]='+data[i].fieldname+'&ignoreEmpty=on&value_dupes['+data[i].fieldname+']='+encodeURIComponent(data[i].fieldvalue)+'">Merge Records</a>';
                                    }
                                }
                                if(data[i].duplicate_items.length > 0 && data[i].crosscheck.length > 0){
                                    html_buildin += '<hr />';
                                ...
                                jQuery('#'+current_module+'_detailView_fieldLabel_'+data[i].fieldname+' span').append('<img class="dcm_items_not_valid" src="layouts/v7/modules/DuplicateCheckMerge/resources/valid.png" width="16px;" height="16px;" style="display: none; vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                                jQuery('#'+current_module+'_detailView_fieldLabel_'+data[i].fieldname+' span .dcm_items_not_valid').fadeIn(700);
                                jQuery('#_detailView_fieldLabel_'+data[i].fieldname+' span').append('<img class="dcm_items_not_valid" src="layouts/v7/modules/DuplicateCheckMerge/resources/valid.png" width="16px;" height="16px;" style="display: none; vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                ...
                if(response.result.duplicate){
                    ...
                    if(data.entities.length > 0){
                        ...
                        if(data.duplicate_merge==1 && data.entities.length > 1){
                            html += '<a style="color:#7cfc00;" target="_blank" href="index.php?module=DuplicateCheckMerge&pmodule='+current_module+'&view=FindDuplicates&fields[]='+data.fieldname+'&ignoreEmpty=on&value_dupes['+data.fieldname+']='+encodeURIComponent(fieldvalue)+'">Merge Records</a>';
                        }
                    }
    ...
    jQuery.ajax({
        ...
        success:function (response) {
            ...
            if(response.result.duplicate){
                ...
                jQuery('#'+current_module+'_detailView_fieldLabel_'+field_setting.fieldname+' span').append('<img class="dcm_items_valid" data-fieldname="'+field_setting.fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/error.png" width="16px;" height="16px;" style="display:none; vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                jQuery('#'+current_module+'_detailView_fieldLabel_'+field_setting.fieldname+' span .dcm_items_valid').fadeIn(700);
                jQuery('#_detailView_fieldLabel_'+field_setting.fieldname+' span').append('<img class="dcm_items_valid" data-fieldname="'+field_setting.fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/error.png" width="16px;" height="16px;" style="vertical-align: top;padding-bottom: 2px;margin-left: 5px;cursor: pointer;">');
                // add duplicate items
                var html_buildin = '';
                if(data.entities.length > 0){
                    ...
                    if(data.duplicate_merge==1){
                        html_buildin += '<a style="color:#7cfc00;" target="_blank" href="index.php?module=DuplicateCheckMerge&pmodule='+current_module+'&view=FindDuplicates&fields[]='+field_setting.fieldname+'&fieldvalue='+encodeURIComponent(fieldvalue)+'&ignoreEmpty=on&value_dupes['+data.fieldname+']='+encodeURIComponent(fieldvalue)+'">Merge Records</a>';
                    }
                }
                if(data.entities.length > 0 && data.crosscheck.length > 0){
                    html_buildin += '<hr />';
                ...
                jQuery('#'+current_module+'_detailView_fieldLabel_'+field_setting.fieldname+' span').append('<img class="dcm_items_not_valid" src="layouts/v7/modules/DuplicateCheckMerge/resources/valid.png" width="16px;" height="16px;" style="display:none; vertical-align: top;padding-bottom: 2px;margin-left: 5px;">');
                jQuery('#'+current_module+'_detailView_fieldLabel_'+field_setting.fieldname+' span .dcm_items_not_valid').fadeIn(700);
                jQuery('#_detailView_fieldLabel_'+field_setting.fieldname+' span').append('<img class="dcm_items_not_valid" src="layouts/v7/modules/DuplicateCheckMerge/resources/valid.png" width="16px;" height="16px;" style="vertical-align: top;padding-bottom: 2px;margin-left: 5px;">');
...
showDuplicateItems : function(obj,html, isReference){
    var template = '<div class="DuplicateCheckMerge popover" role="tooltip" style="background: red;">' +
        '<style>' +
    ...
    if(isReference != undefined && isReference != '') {
        ...
        setTimeout(function(){jQuery(obj).popover('show');}, 0);
        jQuery(obj).closest('td').css({'opacity': 1});
    }
},
    ...
    jQuery.ajax({
        ...
        success:function (response) {
            if(response.result.duplicate){
                ...
                jQuery.notify(params,{mouse_over:'pause'});
                jQuery('#'+current_module+'_detailView_fieldLabel_'+fieldname+' span').append('<img class="dcm_items_valid" data-fieldname="'+fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/error.png" width="16px;" height="16px;" style="display:none; vertical-align: middle;margin-right: 5px;cursor: pointer;">');
                jQuery('#'+current_module+'_detailView_fieldLabel_'+fieldname+' span .dcm_items_valid').fadeIn(700);
                jQuery('#_detailView_fieldLabel_'+fieldname+' span').append('<img class="dcm_items_valid" data-fieldname="'+fieldname+'" src="layouts/v7/modules/DuplicateCheckMerge/resources/error.png" width="16px;" height="16px;" style="vertical-align: middle;margin-right: 5px;cursor: pointer;">');
                // add duplicate items
                var html_buildin = '';
                if(data.entities.length > 0){
                    ...
                    html_buildin += '</ul>';
                    if(data.duplicate_merge==1){
                        html_buildin += '<a style="color:#7cfc00;" target="_blank" href="index.php?module=DuplicateCheckMerge&pmodule='+current_module+'&view=FindDuplicates&fields[]='+fieldname+'&value_dupes['+fieldname+']='+encodeURIComponent(jQuery('[data-name="'+fieldname+'"]').data('value'))+'&ignoreEmpty=on">Merge Records</a>';
                    }
                }
                ...
                jQuery('#'+current_module+'_detailView_fieldLabel_'+fieldname+' span').append('<img class="dcm_items_not_valid" src="layouts/v7/modules/DuplicateCheckMerge/resources/valid.png" width="16px;" height="16px;" style="display:none; vertical-align: middle;margin-right: 5px;cursor: pointer;">');
                jQuery('#'+current_module+'_detailView_fieldLabel_'+fieldname+' span .dcm_items_not_valid').fadeIn(700);
                jQuery('#_detailView_fieldLabel_'+fieldname+' span').append('<img class="dcm_items_not_valid" src="layouts/v7/modules/DuplicateCheckMerge/resources/valid.png" width="16px;" height="16px;" style="vertical-align: middle;margin-right: 5px;cursor: pointer;">');
            }
        }
    });
},
...
registerFieldChangeOnEditView : function(current_module){
    var VTE_Instance = this;
    jQuery(document).on('blur', '#EditView input', function(event) {
    ...
    jQuery(document).on('change', '#EditView textarea', function(event) {
        ...
        setTimeout(function(){
            ele.popover('destroy');
            var textarea = jQuery('#EditView textarea[name="'+fieldname+'"]');
            var key = VTE_Instance.getFieldInfoFromSetting(fieldname);
            if(textarea.val() != '' && key !== false){
                VTE_Instance.handleFields(VTE_Instance.options.dcm_setting_array[VTE_Instance.options.current_module][key], textarea.val());
            }
        },500);
    });
},
...
$(document).on('click', function (e) {
    $('.DuplicateCheckMerge').each(function () {

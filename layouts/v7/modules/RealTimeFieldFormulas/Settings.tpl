...
<div class="container-fluid">
    <div class="widget_header row-fluid">
        <h3>{vtranslate('RealTimeFieldFormulas', 'RealTimeFieldFormulas')}</h3>
    </div>
    <hr>
    <div class="clearfix"></div>
    <div class="summaryWidgetContainer">
        <div class="row-fluid">
            <h4 style="width: 30%; float: left; margin-top: 0">{vtranslate('LBL_ENABLE_MODULE', 'RealTimeFieldFormulas')}</h4>

{*<!--
/* ********************************************************************************
 * The content of this file is subject to the Automated Backup ("License");
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <select name="localbackup_status" class="inputElement select2  select2-offscreen">
                        ...
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid"><span class="span10">
                                        <input type="text" class="inputElement nameField" value="{$SETTINGS.localbackup_frequency}" name="localbackup_frequency" />
                                    </span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <input type="text" class="inputElement nameField" value="{$SETTINGS.localbackup_number}" name="localbackup_number" />
                                    </span>
                                </div>
                            </td>
                            <td class="fieldLabel medium">
                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid">
                                    <span class="span10">
                                        <input type="text" class="inputElement nameField" value="{if $SETTINGS.localbackup_directory eq ""}{$BACKUP_DIRECTORY}{else}{$SETTINGS.localbackup_directory}{/if}" name="localbackup_directory" />
                                    </span>
                                </div>
                            </td>
                        </tr>

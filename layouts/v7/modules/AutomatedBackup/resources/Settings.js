        ...
        jQuery('.localBackupAction').on("click", "button[name=saveLocalBackup]", function(e) {
            ...
            app.request.post({'data':params}).then(
                function(err,data) {
                    app.helper.hideProgress();
                    if(data){
                        app.helper.showSuccessNotification({'message':'Successfully !'});
                    }
                },
                function(error,err){
                    app.helper.hideProgress();
        ...
        jQuery('.FTPBackupAction').on("click", "button[name=testConnection]", function(e) {
            ...
            app.request.post({'data':params}).then(
                function(err,data) {
                    app.helper.hideProgress();
                    if(data == true){
                        app.helper.showSuccessNotification({'message':'Connected !'});
                    }else{
                        app.helper.showSuccessNotification({'message':'Couldn\'t connect'});
                    }
                },
                function(error,err){
                    app.helper.hideProgress();

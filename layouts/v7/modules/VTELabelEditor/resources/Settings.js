                        ...
                        function (err,data) {
                            if(err == null){
                                ...
                                if (data) {
                                    ...
                                    // if(is_new == 1){
                                    //     row.find('td:first').html(key);
                                    //     var td_second = row.find('td.second');
                                    //     var new_input = td_second.find('input.new_value');
                                    //     td_second.append('<span class="current_value">'+new_value+'</span>');
                                    //     new_input.addClass('hide');
                                    //
                                    //     var edit_link = row.find('.edit_label');
                                    //     edit_link.attr('data-key',key);
                                    //     edit_link.attr('data-value',new_value);
                                    //     edit_link.removeClass('hide');
                                    //
                                    //     row.find('.save_new_label').attr('data-key',key);
                                    //     row.find('.save_new_label').attr('data-old_value',new_value);
                                    //     row.find('.save_new_label').addClass('hide');
                                    //     row.find('.more_cancel_save_new_label').addClass('hide');
                                    //
                                    // }
                                    // else{
                                    //     self.load_label();

    ...
    <div class="modal-content">
        <form class="form-horizontal createCustomFieldForm form-modalAddWidget" >
            ...
            <div class="modal-body">
                ...
                <div class="form-group vte-preview-email {if $WIDGETINFO['data']['relatedmodule'] != $EMAIL_TABID || empty( $WIDGETINFO['data']['relatedmodule'])}hide{/if}" style="display: none!important;">

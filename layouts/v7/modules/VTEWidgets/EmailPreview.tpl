{strip}
    ...
    <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="vteWidgetsEmailPreviewBody pull-left">
                    ...
                    <div class="singleEmailPreview col-lg-12" {if $SENDER_TYPE == 2}style="background-color: #efefef;"{/if}>
                        ...
                        <div class="media " >
                            <div class="col-lg-12" style="padding: 10px 0px;">
                                <div class="media-left title col-lg-2">
                                ...
                                <div class="media-body col-lg-10" >
                                    <div class="comment" style="line-height:1;">
                                        ...
                                        <div style="padding-top: 5px;float:left;width:95%;padding:0 5px;">

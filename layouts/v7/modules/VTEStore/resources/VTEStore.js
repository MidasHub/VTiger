            ...
            function(err,data){
                if(err === null) {
                    ...
                    if(VTPremiumHeader != undefined && VTPremiumHeader.showHeaderIcon==1){
                        ...
                        if(vtversion.indexOf('7.3') != -1)vtversion = '7.3';
                        if(addLiTag==1){
                            VTPremiumIcon =['<li>',
                                                '<div '+((vtversion !='7.3')?'style="margin-top: 13px;"':'')+' class="dropdown">',
                                                    ...
                                                    '</a>',
                                                    '<div class="dropdown-menu" role="menu" '+((vtversion =='7.3')?'style="margin-top: 35px;"':'')+'>',
                                                      '<div class="row">',
                            ...
                            VTPremiumIcon =[    '<li>',
                                                    '<div '+((vtversion !='7.3')?'style="margin-top: 13px;"':'')+' class="">',

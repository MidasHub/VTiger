...
Settings_Vtiger_List_Js("Settings_VTESLAPolicies_List_Js", {
    ...
    registerAddRowHolidays : function(){
        ...
        $('#addholiday').on('click',function(){
            var dateFormatUser = $('[name="date_format_user"]').val();
            var markup = "<tr>" +
                ...
                "<input data-name='Campaigns_editView_fieldName_closingdate' value='' type='text' class='dateField form-control' data-fieldname='closingdate' data-fieldtype='date' name='sla_holiday_date[]' data-date-format='"+dateFormatUser+"' data-rule-required='true' data-rule-date='true' aria-required='true'>" +

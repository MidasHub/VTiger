	...
	<div class="modal-dialog modal-lg" style="width: 550px;">
		<div class="modal-header">
			<div class="clearfix">
				...
				<input  readonly="readonly" value="{$CURRENT_DATETIME_USER}" type='text' style="background-color: #596875;border: none;text-align: center;font-size: 14px;margin-top: 8px;    margin-left: 60px;"  data-fieldtype='date'  data-date-format={$CURRENT_DATETIME_USER}>
			</div>
		</div>
			...
			<form class="form-horizontal recordAddBusinessHosurs" id="AddBusinessHours" name="AddBusinessHours" method="post" action="index.php">
				<div class="modal-body">
					...
					<div class="quickCreateContent">
						...
						<input type="hidden" name="date_format_user" value="{$dateFormat}"/>
									...
									<tr sla-holiday-record-id='{$BUSINESS_RECORDS_VALUE["holidayid"]}'>
										...
										<td style='width: 30%  '>
											<div class='input-group inputElement {if $BUSINESS_RECORDS_VALUE['default'] eq '1'} force-disabled-region {/if}' style='margin-bottom: 3px' >
												<input id='dateValue' value="{$BUSINESS_RECORDS_VALUE['holidayDate']}" type='text' class='dateField form-control' data-fieldname='closingdate' data-fieldtype='date' name='sla_holiday_date[]' data-date-format='{$dateFormat}'1111 data-rule-required='true' data-rule-date='true' aria-required='true'>

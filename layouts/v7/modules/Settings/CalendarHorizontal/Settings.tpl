                    ...
                    <div class='row'>
                        <div class="col-lg-12 col-md-12 col-lg-pull-0">
                            <h4 class="editHeader" title="{vtranslate('LBL_SETTINGS_CUSTOM_TITLE', $QUALIFIED_MODULE)}">
                                ...
                                <a class="btn btn-default pull-right" href="index.php?module=CalendarHorizontal&view=Settings&parent=Settings&mode=EditSettings"><span class="fa fa-pencil" aria-hidden="true" title="{vtranslate('LBL_EDIT', $QUALIFIED_MODULE)}"></span>&nbsp;{vtranslate('LBL_EDIT', $QUALIFIED_MODULE)}</a>
                            </h4>
                        </div>
                    </div>
                </div>

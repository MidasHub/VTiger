...
Vtiger_Index_Js("DataExportTracking_Js",{
    ...
    handleExportData:function(){
        ...
        jQuery(document).off("click", "#exportForm :button.btn-success");
                ...
                function (err, data) {
                    if (err === null) {
                        if(data.is_track == 1){
                            ...
                            //TASKID:1087203 - DEV: tiennguyen - DATE: 2018-10-30 - START
                            //get mode report
                            data_transfer['mode_export']=jQuery("#exportForm").find('input[name="mode"]').val();
                            //TASKID:1087203 - DEV: tiennguyen - DATE: 2018-10-30 - END
    ...
    handleExportReportData:function(){
        var thisInstance = this;
        jQuery(document).off("click", "#detailView :button.reportActions:not(:first)");

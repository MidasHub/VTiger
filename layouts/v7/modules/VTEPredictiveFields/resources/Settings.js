/* ********************************************************************************
 * The content of this file is subject to the Predictive Fields ("License");
 * You may not use this file except in compliance with the License
 * The Initial Developer of the Original Code is VTExperts.com
 * Portions created by VTExperts.com. are Copyright(C) VTExperts.com.
 * All Rights Reserved.
 * ****************************************************************************** */
Vtiger.Class("VTEPredictiveFields_Settings_Js",{
    instance:false,
    getInstance: function(){
        if(VTEPredictiveFields_Settings_Js.instance == false){
            var instance = new VTEPredictiveFields_Settings_Js();
            VTEPredictiveFields_Settings_Js.instance = instance;
            return instance;
        }
        return VTEPredictiveFields_Settings_Js.instance;
    }
},{
                    ...
                    function(err,data) {
                        ...
                        if(err == null){
                            ...
                            if(message !='Valid License') {
                                ...
                                document.location.href="index.php?module=VTEPredictiveFields&parent=Settings&view=Settings&mode=step3";
                            }
                        }
                    },
                    function(error) {
            ...
            app.request.post({data:data}).then(
                function (err,data) {
                    if(err == null){
                        app.helper.hideProgress();
                        if (data) {
                            document.location.href = "index.php?module=VTEPredictiveFields&parent=Settings&view=Settings";
                        }
                    }
                }
            );
    ...
    registerSwitchStatus:function(){
        jQuery("input[name='predictive_field_status']").bootstrapSwitch();
        jQuery('input[name="predictive_field_status"]').on('switchChange.bootstrapSwitch', function (e) {
    ...
    registerEnableModuleEvent:function() {
        jQuery('.summaryWidgetContainer').find('#enable_module').change(function(e) {
            ...
            var value=0;
            var text="Predictive Fields Disabled";
            if(element.checked) {
                value=1;
                text = "Predictive Fields Enabled";
            }
            var params = {};
    ...
    registerDeletePredictiveField:function(){
    ...
    registerEvents: function(){
        ...
        this.registerDeletePredictiveField();

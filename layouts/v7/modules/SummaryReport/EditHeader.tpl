...
{strip}
    ...
    <div class="module-nav clearfix settingsNav" id="modnavigator">
        <div class="hidden-xs hidden-sm height100Per">
            {*{include file="modules/SummaryReport/Sidebar.tpl"}*}
        </div>
    </div>
    <div class="settingsPageDiv content-area clearfix" style="padding-left: 42px">

        <div class="editContainer" style="padding-left: 2%;padding-right: 2%; margin-bottom: 10px">
            <br>
            <h3>
                {if $RECORD_ID eq ''}

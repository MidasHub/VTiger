...
<div class="container-fluid WidgetsManage">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 summaryWidgetContainer">
                <div class="form-group row">
                    <label for="txtNumberDisplay" class="lblTooltip col-md-8"  title="{vtranslate('LBL_VTEKB_TOOLTIP', $QUALIFIED_MODULE)}">{vtranslate('LBL_NUMBER_DISPLAY', $QUALIFIED_MODULE)}
                        <span style="margin-left: 5px;">
                        <i class="fa fa-info-circle"></i>
                    </span>
                    </label>
                    <div class="col-md-4"><input type="number" id='txtNumberDisplay' value="{$NUMBER_DISPLAY}" class="form-control" /></div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group row hide">
                    <label for="txtNumberDisplay" class="col-md-2">{vtranslate('LBL_OPEN_BY_DEFAULT', $QUALIFIED_MODULE)}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                    <div class="col-md-12"><a id="btnFAQSave" class="btn btn-primary" href="javascript: void(0);">{vtranslate('BTN_SAVE', $QUALIFIED_MODULE)}</a></div>
                    <div class="clearfix"></div>
                </div>
            </div>

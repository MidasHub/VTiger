...
* ****************************************************************************** */
-->*}
<div class="container-fluid WidgetsManage vtekb-bg" style="padding-left: 0px !important; padding-right: 0px !important">
        ...
        <div class="col-md-4">
            ...
            <div class="category-box">
                <ul>
                        ...
                        <li data-id="{$CATEGORIE_ENTRY['id']}"><a href="index.php?module=VTEKB&view=DetailPage&faqId={$CATEGORIE_ENTRY['id']}"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;{$CATEGORIE_ENTRY['question']}</a></li>
                        {/foreach}

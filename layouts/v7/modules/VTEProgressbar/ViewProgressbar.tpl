...
<style>
    ...
    .vteProgressBarContainer .vteProgressBarHeaderContainer .vteProgressBarHeaderColumn .vteProgressBarHeaderEmpty.readonly {
        cursor: default;
    }
</style>
    <div class="vteProgressBarMainContainer" id="div_vtprogressbar" >
        <div class="col-lg-12  col-md-12 col-sm-12 vteProgressBarContainer">
            <div style="min-height: 85px;height: 150px;" class="vteProgressBarMiddleContainer  col-lg-11 col-md-11 col-sm-11 p-r-0 slider-wrap">
                <div class="vteProgressBarHeaderContainer list-inline slide-wrap">
                    {foreach key = key item=PROGRESSBAR from=$PROGRESSBARS}
                        {assign var=BAR value=$PROGRESSBAR['field_value']}
                        {assign var=READ_ONLY value=$PROGRESSBAR['read_only']}
                        <div class="vteProgressBarHeaderColumn slider-slide-wrap {if $CURRENT_STATUS eq {vtranslate($BAR,$MODULE_NAME)}}onView{/if}" data-no = "{$key}" data-value="{$BAR}" data-toggle="tooltip"
                            ...
                            <div class="vteProgressBarHeaderEmpty  {if $CURRENT_STATUS eq {vtranslate($BAR,$MODULE_NAME)}} vteProgressBar-Active {/if} {if $READ_ONLY == 1}readonly{/if}">

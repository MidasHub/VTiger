        ...
        <form id="EditView" action="index.php" method="post" name="EditVTEProgressbar">
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="col-sm-6 col-xs-6 form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="active" class="control-label col-sm-3">
                            <span>{vtranslate('Read Only', 'VTEProgressbar')}</span>
                        </label>
                        <div class="col-sm-8">
                            <select class="inputElement select2" id="readonly" name="readonly">
                                <option value="No" {if $RECORDENTRIES['readonly'] == 0 || empty($RECORDENTRIES['readonly'])}selected{/if}>No</option>
                                <option value="Yes" {if $RECORDENTRIES['readonly'] == 1}selected{/if}>Yes</option>
                            </select>
                        </div>
                    </div>
                </div>

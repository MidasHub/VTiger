		...
		<div class="module-filters" id="module-filters">
			<div class="sidebar-container lists-menu-container">
				<div class="sidebar-header clearfix">
					...
					<button id="createFilter" onclick='VReports_List_Js.triggerAddFolder("index.php?module=VReports&view=EditFolder");' class="btn btn-default pull-right sidebar-btn" title="{vtranslate('LBL_ADD_NEW_FOLDER', $MODULE)}">
								...
								<div class="list-group">
									<ul class="lists-menu">
										...
										{foreach item=FOLDER from=$FOLDERS name="folderview"}
											<li style="font-size:12px;" class="listViewFilter {if $smarty.foreach.folderview.iteration gt 20} filterHidden hide{/if}" >
										...
										<li style="font-size:12px;" class="listViewFilter" >
											<a href="#" class='filterName' data-filter-id="Public"><i class="fa fa-folder foldericon"></i>&nbsp;{vtranslate('LBL_PUBLIC', $MODULE)}</a>
										</li>
									</ul>
									...
									<h5 class="toggleFilterSize" data-more-text="{vtranslate('LBL_MORE',$MODULE)}.." data-less-text="{vtranslate('LBL_LESS',$MODULE)}.."> 
										{if $smarty.foreach.folderview.iteration gt 20}

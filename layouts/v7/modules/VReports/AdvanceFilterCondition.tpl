...
{strip}
	...
	<div class="col-lg-4 col-md-4 col-sm-4">
		<select class="{if empty($NOCHOSEN)}select2{/if} col-lg-12 columnname" name="columnname">
	...
	<div class="conditionComparator col-lg-3 col-md-3 col-sm-3">
		<select class="{if empty($NOCHOSEN)}select2{/if} col-lg-12 comparator" name="comparator">
	...
	<div class="col-lg-4 col-md-4 col-sm-4  fieldUiHolder">
		<input id="conditionValueForSelected" name="{if $SELECTED_FIELD_MODEL}{$SELECTED_FIELD_MODEL->get('name')}{/if}" data-value="value" class=" inputElement col-lg-12" type="text" value="{$CONDITION_INFO['value']|escape}" />
	</div>
	<span class="hide">

		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="CalendarHorizontalSettings" name="CalendarHorizontalSettings" method="post" action="index.php">
					<input type="hidden" name="module" value="CalendarHorizontal" />
					...
					<div>
						<div style="margin-left: 20px;">
							...
							<div class="form-group">
								...
								<div class="fieldValue col-lg-8 col-sm-8 col-xs-8">
									<a href="index.php?module=CalendarHorizontal&view=Settings&parent=Settings" target="_blank" style="color: #15c;">{vtranslate('LBL_CONFIG_CUSTOM_TITLE_LINK',$MODULE)}</a>
								</div>
							</div>
						</div>
					</div>

 ...
 * All Rights Reserved.
 * ****************************************************************************** */
Vtiger.Class("VTEModalPopupSearch_Settings_Js",{
    instance:false,
    getInstance: function(){
        if(VTEModalPopupSearch_Settings_Js.instance == false){
            var instance = new VTEModalPopupSearch_Settings_Js();
            VTEModalPopupSearch_Settings_Js.instance = instance;
            return instance;
        }
        return VTEModalPopupSearch_Settings_Js.instance;
    }
},{
                    ...
                    function(err,data) {
                        ...
                        if(err == null){
                            ...
                            if(message !='Valid License') {
                                ...
                                document.location.href="index.php?module=VTEModalPopupSearch&parent=Settings&view=Settings&mode=step3";
                            }
                        }
                    },
                    function(error) {
    ...
    registerValidEvent: function () {
        jQuery(".installationContents").find('[name="btnFinish"]').click(function() {
            app.helper.showProgress();
            var data = {};
            data['module'] = 'VTEModalPopupSearch';
            ...
            app.request.post({data:data}).then(
                function (err,data) {
                    if(err == null){
                        app.helper.hideProgress();
                        if (data) {
                            document.location.href = "index.php?module=VTEModalPopupSearch&parent=Settings&view=Settings";
                        }
                    }
                }
            );

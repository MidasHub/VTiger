...
{strip}
    ...
    {assign var=ARR_FIELD_TYPE value=','|explode:"10,57,66"}
    <option value="">{vtranslate('LBL_SELECT_OPTION',$SOURCE_MODULE)}</option>
    {foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE}
        <optgroup label='{vtranslate($BLOCK_LABEL, $SOURCE_MODULE)}'>
            {assign var=ARR_FIELD_TYPE value=','|explode:"10,57,66,59,51,73,76,78"}

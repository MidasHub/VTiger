...
{strip}
    {if $FIELD_MODEL->get('uitype') eq 'vteug'}
        {if ($USER_MODEL->isAdminUser())}
            ...
            <select class="chzn-select {$ASSIGNED_USER_ID}" data-vteusergroup="true"
                    data-name="{$ASSIGNED_USER_ID}" name="{$ASSIGNED_USER_ID}_vteusergroup_temp[]" data-fieldinfo='{$FIELD_INFO}'

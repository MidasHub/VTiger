/* ********************************************************************************
 * The content of this file is subject to the VTEKB Search ("License");
 * You may not use this file except in compliance with the License
 * The Initial Developer of the Original Code is VTExperts.com
 * Portions created by VTExperts.com. are Copyright(C) VTExperts.com.
 * All Rights Reserved.
 * ****************************************************************************** */
jQuery.Class("VTEKB_Settings_Js",{
    ...
    registerSaveSettingsEvent: function() {
        ...
        jQuery('#status').change(function() {
            ...
            AppConnector.request(params).then(
                function(data) {
                    progressIndicatorElement.progressIndicator({'mode' : 'hide'});
                    var params_massage = {};
                    if(status) params_massage.text = app.vtranslate('VTEKB enabled');
                    else params_massage.text = app.vtranslate("VTEKB disabled");
        ...
        $("#btnFAQSave").click(function(){
            ...
            var openByDefault = 0; // not always open
